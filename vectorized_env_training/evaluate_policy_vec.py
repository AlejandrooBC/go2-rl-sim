...
eval_env = VecNormalize.load("vecstats/ppo_go2_vec_20250717-130255_checkpoint__vecnormalize_10000000_steps.pkl", dummy_env)
...
model = PPO.load("trained_models_vec/ppo_go2_vec_20250717-130255")  # Update filename
