...
class UnitreeGo2Env(gym.Env):
    ...
    def step(self, action):
        ...
        alive_bonus = 0.5 # Small constant reward to encourage survival
        duration_reward = 0.05 * self.step_counter if forward_vel > 0.1 else 0.0 # Small reward to keep moving
