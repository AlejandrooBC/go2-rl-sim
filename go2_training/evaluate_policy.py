...
eval_env = VecNormalize.load("vecstats/ppo_go2_20250707-202439_vecnormalize.pkl", eval_env)
...
model = PPO.load("trained_models/ppo_go2_20250707-202439", env=eval_env)
